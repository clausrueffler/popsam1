...
respectively. Varying both parameters together gives you 18 parameter combinations which you can arrange in a table with three rows (*n*) and six columns (*min*). In each cell of this table, enter the proportion of 20 runs that result in extinction. Do these simulations for *tmax=500*, of if this takes too long, for *tmax=200*.
  ...
  (2)
Keep *tmax=500* fixed and vary *min* and *max* according to
...
For each *min/max* report the proportion of 20 runs in which the population goes extinct.
  ...
  (3)
For *tmax=500* and a pair of *min* and *max* of your own choice explore the effect of *N(0)* by varying it according to
*N0=(1; 2; 3; 5; 10; 50)*.
